...
#handling python exceptions at local level 
try:
    x = 1 / 1
except ZeroDivisionError:
...
#handling python exceptions at intermediate level 
def divide(x, y):
    try:
        result = x / y
        ...
        print("Code by DataCamp")


#handling python exceptions at global level``
def main():
    try:
        my_list = [1, 2, 3]
        print(my_list[5])
